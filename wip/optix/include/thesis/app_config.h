...
struct AppConfig {
    ...
    std::optional<std::pair<int, std::string>> parse(int argc, char* argv[]) {
        ...
        app.add_option("-s,--num_samples", num_samples_per_pixel_, "Number of samples per pixel")->required(false);
        ...
        app.add_option("-r,--raygen", raygen_function_name_, "Name of the raygen function in the PTX")->required(false);
        app.add_option("-m,--miss", miss_function_name_, "Name of the miss function in the PTX")->required(false);
        app.add_option("-c,--closesthit", hitgroup_function_name_, "Name of the hitgroup function in the PTX")->required(false);
        app.add_option("-l,--launch_params", launch_params_variable_name_, "Name of the launch params variable in the PTX")->required(false);
