...
under the run-to-run jitter), with renders numerically equivalent. The total reserved bytes
per ray matter more than which cap reserves them. The hit buffer consumes them three times faster per entry and is
