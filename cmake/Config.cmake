...
elseif (DEFINED ENV{OPTIX_ROOT})
    set(DEFAULT_OPTIX_ROOT "$ENV{OPTIX_ROOT}")
else()
    set(DEFAULT_OPTIX_ROOT "$ENV{HOME}/optix")
endif()
set(OPTIX_ROOT "${OPTIX_ROOT}" CACHE PATH "Path to OptiX SDK (override with -DOPTIX_ROOT= or the OPTIX_ROOT env var)")
if(NOT OPTIX_ROOT)
