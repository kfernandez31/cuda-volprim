...
with a root-find (Newton or bisection) within each multi-primitive segment, inverting single-primitive
segments in closed form (their~\S5.1). That segment-by-segment
