...
environment lighting, default off) and a rigorously characterised ledger of negative results. At equal
...
re-measuring there. Third, \emph{recompile-free capacity}: the per-ray buffers are compile-time constants whose size the
